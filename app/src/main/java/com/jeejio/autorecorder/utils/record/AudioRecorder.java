...
/**
 * @ClassName: AudioRecorder.java
 * @Description:用于实现录音 暂停录音
 * @Author: victory
...
public class AudioRecorder {
     ...
     * @param fileName
     */
    public void createDefaultAudio(String wavFileName, String fileName) {
        // 获得缓冲区字节大小
    ...
    public void startRecord(final RecordStreamListener listener) {
        ...
        if (TextUtils.isEmpty(wavFileName) || TextUtils.isEmpty(fileName)) return;
...
//        }
    ...
    private void mergePCMFilesToWAVFile(final List<String> filePaths) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                if (PcmToWav.mergePCMFilesToWAVFile(filePaths, FileUtils.getWavFileAbsolutePath(wavFileName, fileName))) {
                    //操作成功
                } else {
                    //操作失败
    ...
    private void makePCMFileToWAVFile() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                if (PcmToWav.makePCMFileToWAVFile(FileUtils.getPcmFileAbsolutePath(wavFileName), FileUtils.getWavFileAbsolutePath(wavFileName, fileName), true)) {
                    //操作成功
                } else {
                    //操作失败
